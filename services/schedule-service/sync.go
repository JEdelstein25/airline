...
// syncScheduleFlightInstances synchronizes flight instances based on schedule changes
...
// syncScheduleAction represents an action to take during sync
...
// planScheduleFlightInstancesSync plans actions to synchronize flight instances with schedule
